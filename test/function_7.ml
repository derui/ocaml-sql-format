...
let%expect_test "function_7 for formatting" =
  ...
  [%expect
    {|
      SELECT
          TIMESTAMPADD(SQL_TSI_FRAC_SECOND, 'express', 3),TIMESTAMPADD(SQL_TSI_SECOND, 'express', 3),TIMESTAMPADD(SQL_TSI_MINUTE, 'express', 3),TIMESTAMPADD(SQL_TSI_HOUR, 'express', 3),TIMESTAMPADD(SQL_TSI_DAY, 'express', 3),TIMESTAMPADD(SQL_TSI_WEEK, 'express', 3),TIMESTAMPADD(SQL_TSI_MONTH, 'express', 3),TIMESTAMPADD(SQL_TSI_QUARTER, 'express', 3),TIMESTAMPADD(SQL_TSI_YEAR, 'express', 3),TIMESTAMPDIFF(SQL_TSI_FRAC_SECOND, 'express', 3),TIMESTAMPDIFF(SQL_TSI_SECOND, 'express', 3),TIMESTAMPDIFF(SQL_TSI_MINUTE, 'express', 3),TIMESTAMPDIFF(SQL_TSI_HOUR, 'express', 3),TIMESTAMPDIFF(SQL_TSI_DAY, 'express', 3),TIMESTAMPDIFF(SQL_TSI_WEEK, 'express', 3),TIMESTAMPDIFF(SQL_TSI_MONTH, 'express', 3),TIMESTAMPDIFF(SQL_TSI_QUARTER, 'express', 3),TIMESTAMPDIFF(SQL_TSI_YEAR, 'express', 3)
      FROM
          a |}]
