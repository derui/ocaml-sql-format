include (
  struct
    ...
    let t : t =
      ...
      |> Kind_map.add K.N_common_value_expression (module Parser_common_value_expression : Intf.GEN)
      ...
      |> Kind_map.add K.N_non_numeric_literal (module Parser_non_numeric_literal : Intf.GEN)
      |> Kind_map.add K.N_unsigned_numeric_literal (module Parser_unsigned_numeric_literal : Intf.GEN)
      |> Kind_map.add K.N_unsigned_value_expression_primary (module Parser_unsigned_value_expression_primary : Intf.GEN)
      |> Kind_map.add K.N_value_expression_primary (module Parser_value_expression_primary : Intf.GEN)
      (* statements *)
